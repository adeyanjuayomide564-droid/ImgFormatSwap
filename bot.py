...
SUPPORTED_FORMATS = {
    ...
    "TIFF": "TIFF",
    "GIF": "GIF",
    "PDF": "PDF"  # PDF conversion supported via PIL
}
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Show format selection (same as handle_image)
    keyboard = [
        [
            InlineKeyboardButton("🖼 JPEG", callback_data="JPEG"),
            InlineKeyboardButton("📸 PNG", callback_data="PNG"),
    ...
    try:
        ...
        if format_choice == "GIF" and getattr(image, 'is_animated', False):
            ...
            if format_choice == "PDF":
                ...
                image.save(output, format=format_choice, quality=95)
            output.seek(0)
...
async def about_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    about_text = (
        ...
        "🔹 Deployed on Railway\n\n"
        "📝 **Source Code:**\n"
        "Check the GitHub repository for this bot!\n\n"
        "Enjoy converting! 🎨"
    )
